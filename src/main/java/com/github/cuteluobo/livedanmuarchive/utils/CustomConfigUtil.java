...
import com.github.cuteluobo.livedanmuarchive.enums.ConfigRecordField;
...
public class CustomConfigUtil {
     ...
     * @return
     */
    private YamlMapping initConfig() {
        YamlMapping config = Yaml.createYamlMappingBuilder()
